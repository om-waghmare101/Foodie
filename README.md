...
🔗 link here :  https://foodie-smoky-mu.vercel.app
...
2. Use the search bar to filter food items.
...
7. View the total amount.
8. Click **Place Order**.
9. Scan the QR code to complete payment.
...
- Database Support (MongoDB/Firebase/MySQL)
- Admin Dashboard
- Order Tracking
